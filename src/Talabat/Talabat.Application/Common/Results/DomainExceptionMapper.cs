...
public static class DomainExceptionMapper
{
    public static ApplicationError Map(Exception exception)
    {
        ...
        return exception switch
        {
            ...
            DeliveryNotAssignedException ex => Conflict(ex.GetType().Name, ex.Message),
            DeliveryTerminalStateException ex => Conflict(ex.GetType().Name, ex.Message),
            ...
            InvalidDeliveryStatusTransitionException ex => Conflict(ex.GetType().Name, ex.Message),
            InvalidDeliveryTimestampException ex => Validation(ex.GetType().Name, ex.Message),
            InvalidDeliveryAgentStatusTransitionException ex => Conflict(ex.GetType().Name, ex.Message),
