...
public sealed class OpenApiDocumentQualityTests : IClassFixture<CustomWebApplicationFactory>
{
    ...
    public async Task CommittedOpenApi_MatchesRuntimeDocument()
    {
        ...
        var projectDir = Path.GetFullPath(
            Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "..", "src", "Talabat", "Talabat.API"));
        var committedPath = Path.Combine(projectDir, "openapi", "customer-api.json");
        var generatedPath = Path.Combine(projectDir, "openapi", "Talabat.Customer.API.json");
